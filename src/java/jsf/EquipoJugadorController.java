...
import entidades.EquipoJugadorFacade;
...
@Named("equipoJugadorController")
@SessionScoped
public class EquipoJugadorController implements Serializable {

    @EJB
    private entidades.EquipoJugadorFacade ejbFacade;
    ...
    public EquipoJugador getEquipoJugador(java.lang.Integer id) {
    ...
    public static class EquipoJugadorControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEquipoJugador(getKey(value));
        }
